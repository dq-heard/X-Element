    ...
    <section className="section policy">
      <article className="container">
        ...
        <p>
          ...
          information. You may also choose to opt out of certain types of
        ...
        <p>
          ...
          material changes to this Policy, we will provide notice of such
          changes by posting a notice on our website or by other means.
        </p>
        ...
        <p>
          ...
          <a href="mailto:officialxelement@gmail.com" target="_blank">
            <strong>officialxelement@gmail.com</strong>
          </a>
          ].
        </p>
      </article>
